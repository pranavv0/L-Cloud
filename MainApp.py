...
#("Operating System",3)]
    ...
    def __init__(self,master):
        ...
        self.soft_names = ['Gedit','Browser','VNCViewer']
        Label(self.displays[1],text='Softwares',fg="#991111").grid(row=0,column=0,columnspan=2,pady=10)
        self.laun = IntVar()
        #self.laun.set(4)
    ...
    def setaccountframe(self):
        ...
        self.msg = Label(self.acc_frames['first'],text="Welcome to LCloud-Linux Cloud Services",fg="#879898",font="Times 16 bold")
        self.msg.grid(row=0,column=0,columnspan=2,padx=10,pady=10)

        self.description = Message(self.acc_frames['first'],text=''' LCloud provides the cloud solutions in the form of SaaS, STaaS, and OSaaS''')
        #self.description.insert(END,'''We provides the cloud solutions''')
        self.description.grid(row=1,columnspan=2,sticky=N)
        #Login Button
        self.loginbutton = Button(self.acc_frames['first'],text="Log In",command=self.gotologin,width=25,font="Times 11 bold")
        self.loginbutton.grid(row=4,column=0,pady=10)
        #Register Button
        self.regbutton = Button(self.acc_frames['first'],text="Register",command=self.register,width=25,font="Times 11 bold")
    ...
    def gotologin(self):
        ...
        Label(self.acc_frames['login'],text="Welcome to LCloud xxServices",fg="#879898",font="Times 16 bold").grid(row=0,column=0,columnspan=2,padx=10,pady=10)
    ...
    def register(self):
        self.acc_frames['first'].grid_forget()
        Label(self.acc_frames['register'],text="Registeration",fg="#879898",font="Times 16 bold").grid(row=0,column=0,columnspan=2,padx=10,pady=10)
    ...
    def mount(self):
        ...
        self.directory = subprocess.getoutput('cd ; pwd') +  '/' + 'LCloud'
